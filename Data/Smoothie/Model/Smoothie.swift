...
struct Smoothie: Identifiable, Codable {
    ...
    var measuredIngredients: [Ingredient.Measured]
}
...
extension Smoothie {
    ...
    var menuIngredients: [Ingredient.Measured] {
...
extension Smoothie {
    init(id: Smoothie.ID, title: String, @SmoothieBuilder _ makeIngredients: () -> (AttributedString, [Ingredient.Measured])) {
...
enum SmoothieBuilder {
    static func buildBlock(_ description: AttributedString, _ ingredients: Ingredient.Measured...) -> (AttributedString, [Ingredient.Measured]) {
    ...
    static func buildBlock(_ ingredients: Ingredient.Measured...) -> (String, [Ingredient.Measured]) {
        fatalError()
    }
}
