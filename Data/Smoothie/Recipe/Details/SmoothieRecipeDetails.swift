...
// MARK: - Body
extension Smoothie.Recipe.Details {
    var body: some View {
        ScrollView {
                ...
                VStack(alignment: .leading) {
                    ...
                    VStack {
                        ForEach(0 ..< smoothie.measuredIngredients.count, id: \.self) { index in
                            Ingredient.Row(measuredIngredient: smoothie.measuredIngredients[index].scaled(by: Double(smoothieCount)))
                                .padding(.horizontal)
...
struct RecipeView_Previews: PreviewProvider {
    static var previews: some View {
        Smoothie.Recipe.Details(smoothie: .thatsBerryBananas)
